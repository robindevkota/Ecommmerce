      ...
      <div className="flex justify-center mobile:flex-col mobile:mt-4 mobile:p-3">
        ...
        <div className="flex-[1.3] flex flex-col items-start  justify-items-center mt-10 mobile:items-center">
          ...
          <p className="disription pr-[4rem] text-justify mt-4 mobile:pr-0">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum culpa libero atque corrupti ipsum? Aliquam voluptate dicta quam distinctio, molestias cum? Illum, porro qui aut illo ut doloremque. Ut fuga repellat corrupti nam inventore!
          </p>
